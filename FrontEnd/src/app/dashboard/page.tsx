...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Dashboard Pemantauan Level Air</h1>
        <p className="text-gray-600">Pemantauan dan kontrol level air secara real-time</p>
      </div>
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span>Atur Pengaturan Ambang Batas</span>
                </div>
              </a>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-600">Daring</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-600">Beroperasi</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Pemeriksaan Terakhir:</span>
